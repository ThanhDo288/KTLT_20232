...
void Admin::addKhachHang() {
    string filePath = "D:/choi c++/BTL20232/KTLT_20232/BTL_CHOT/KH.txt";
    ...
    if (!outFile.is_open()) {
        cout << "Khong the mo file KhachHang.txt de ghi\n";
        return;
    }
    ...
    string folderPath = "D:/choi c++/BTL20232/KTLT_20232/BTL_CHOT/DATABASE/KH/" + newId;
...
void Admin::addNhanVien() {
    string filePath = "D:/choi c++/BTL20232/KTLT_20232/BTL_CHOT/NV.txt";
...
void Admin::addLuong() {
    ...
    string rootPath = "D:/choi c ++/BTL20232/KTLT_20232/BTL_CHOT/DATABASE/NV" + nvId;
...
void Admin::addBenhAn() {
    ...
    string rootPath = "D:/choi c ++/BTL20232/KTLT_20232/BTL_CHOT/DATABASE/KH" + khId;
...
void Admin::searchNhanVien() const {
    ...
    ifstream file("D:/choi c ++/BTL20232/KTLT_20232/BTL_CHOT/NV.txt");
    if (file.is_open()) {
        string line;
        while (getline(file, line)) {
            cout << line << "\n";
        ...
        cout << "Khong the mo file NhanVien.txt\n";
    }
}

void Admin::searchKhachHang() const {
    cout << "Danh sach khach hang:\n";
    ifstream file("D:/choi c ++/BTL20232/KTLT_20232/BTL_CHOT/KH.txt");
    if (file.is_open()) {
        string line;
        while (getline(file, line)) {
            cout << line << "\n";
        ...
        cout << "Khong the mo file KhachHang.txt\n";
    }
}
